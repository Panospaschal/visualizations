looker.plugins.visualizations.add({
    id: "panos_kpi_card_no_chart",
    label: "Simple KPI Card (No Chart)",
    has_totals: true, 
    ...
    create: function(element, config) {
        element.innerHTML = `
            <style>
                ...
                .comparisons-wrapper { display: flex; flex-direction: column; gap: 8px; margin-bottom: 0; }
                .kpi-sub-value { font-size: 13px; font-weight: 500; display: flex; align-items: center; gap: 8px; color: #5f6368;}
                .badge { padding: 4px 8px; border-radius: 4px; font-weight: 700; font-size: 12px; min-width: 45px; text-align: center;}
