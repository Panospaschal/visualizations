...
- `src/acme_pivot_plus.js`: Custom Looker pivot table plugin with styling rules, subtotals, and expand/collapse.
...
4. In Explore, choose visualization type "Acme Bar Plus", "Acme Pie Custom", or "Acme Pivot Plus".
